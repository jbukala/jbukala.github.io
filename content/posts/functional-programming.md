...
4. **Lazy evaluation**: This is the idea that Haskell expressions do not get evaluated until its results are needed. This allows it to work with infinite data structures
...
Some examples of them are listed below, but array languages you have more likely used yourself are MATLAB, Julia, R, but also for example the Python NumPy library. Most of them have been inspired by APL.
...
* Seems like a good fit for data processing pipelines.
